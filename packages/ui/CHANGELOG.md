...
- [`e102115`](https://github.com/MarcGonzalezMoratona/sharkui/commit/e102115a82794e42b8d1ffa4e3a4102d770042d4) Thanks [@MarcGonzalezMoratona](https://github.com/MarcGonzalezMoratona)! - Add the **Accordion** component — a disclosure widget built on Base UI, exporting `Accordion`, `AccordionItem`, `AccordionTrigger`, and `AccordionContent`:
